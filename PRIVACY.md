...
- **Browsing activity disclosure:** Facebook matching requests listing and seller-profile URLs. This consent declaration does not grant access to your general browser history; MarketMute does not request the history permission.
